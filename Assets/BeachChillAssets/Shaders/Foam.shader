...
////// Emissive:
                ...
                float4 node_6975 = _Time;
                float2 node_362 = (float2(i.uv0.r,(i.uv0.g+0.9))+node_6975.g*float2(0,0.02));
